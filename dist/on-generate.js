...
async function onGenerate(options) {
    try {
        ...
        const clientOutput = isNewClient ? `${prismaClient.output.value}/client.ts` : (0, source_path_1.buildTypesFilePath)(prismaClient.output.value, config.clientOutput, options.schemaPath);
